...
from camel.configs import ChatGPTConfig, QwenConfig, VLLMConfig, OpenRouterConfig, GeminiConfig, NvidiaConfig
import math
...
def get_agent_config(model_type):
    ...
    #     }
        ...
        agent_config = {
            ...
            "model_config": NvidiaConfig().as_dict(),
            "model_platform": ModelPlatformType.NVIDIA,
            'max_images': 99
        }
    elif model_type == 'llama-4-scout-17b-16e-instruct':
        agent_config = {
            'model_type': 'meta/llama-4-scout-17b-16e-instruct',
            'model_config': NvidiaConfig().as_dict(),
            'model_platform': ModelPlatformType.NVIDIA,
            'max_images': 99
        }
    ...
    elif model_type == 'qwen3-vl-32b-instruct':
            agent_config = {
    ...
    elif model_type == 'qwen3-235b-a22b':
        agent_config = {
    ...
    elif model_type == 'qwen2.5-vl-32b-instruct':
        agent_config = {
    ...
    elif model_type == 'qwen2.5-vl-72b-instruct':
        agent_config = {
            'model_type': 'qwen2.5-vl-72b-instruct',
            'model_config': QwenConfig().as_dict(),
            'model_platform': ModelPlatformType.QWEN,
            'max_images': 99
        }
    ...
    elif model_type == 'openkey-gpt-o3':
        agent_config = {
            "model_type": "o3",
            "model_config": ChatGPTConfig().as_dict(),
            "model_platform": ModelPlatformType.OPENAI_COMPATIBLE_MODEL,
    ...
    elif model_type == 'poxie-gpt-o3':
        agent_config = {
            "model_type": "o3",
            "model_config": ChatGPTConfig().as_dict(),
            "model_platform": ModelPlatformType.OPENAI_COMPATIBLE_MODEL,
            "url": "https://api-eu-central-1-dc8.poixe.com",
        }
    elif model_type == 'poxie-gpt-4o':
        agent_config = {
            "model_type": "gpt-4o",
            "model_config": ChatGPTConfig().as_dict(),
            "model_platform": ModelPlatformType.OPENAI_COMPATIBLE_MODEL,
    ...
    elif model_type == 'openkey-gpt-5.2':
        agent_config = {
            "model_type": "gpt-5.2",
            "model_config": ChatGPTConfig().as_dict(),
            "model_platform": ModelPlatformType.OPENAI_COMPATIBLE_MODEL,
    ...
    elif model_type == 'openkey-gpt-4o-mini':
        agent_config = {
    ...
    elif model_type == 'poixe-gpt-4o-mini':
        agent_config = {
            "model_type": "gpt-4o-mini",
            "model_config": ChatGPTConfig().as_dict(),
            "model_platform": ModelPlatformType.OPENAI_COMPATIBLE_MODEL,
    ...
    elif model_type == 'openkey-gpt-oss-120b':
        agent_config = {
