...
Please follow the above instructions to reproduce the main results.

Some examples of generated posters and corresponding bullet points are provided in the `example/` directory for reference.
